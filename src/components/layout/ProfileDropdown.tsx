    ...
    <div className="relative" ref={ref}>
      ...
      >
        <span className="hidden text-right lg:block">
          ...
          {subtitle && <span className="block text-xs font-medium">{subtitle}</span>}
        </span>
        ...
        <span className="h-12 w-12 overflow-hidden rounded-full">
          {avatarUrl ? (
            ...
            <span className="flex h-full w-full items-center justify-center bg-primary text-lg font-bold text-white">
              {initial}
            </span>
          )}
        </span>
        ...
        <svg
          className={`hidden fill-current sm:block ${open ? 'rotate-180' : ''}`}
          width="12"
          height="8"
          viewBox="0 0 12 8"
          fill="none"
      ...
      {open && (
        <div className="absolute right-0 mt-4 flex w-60 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              ...
              return (
                <li key={link.href}>
                  <Link
                    ...
                    className="flex items-center gap-3.5 text-sm font-medium text-body duration-300 ease-in-out hover:text-primary dark:text-bodydark lg:text-base"
                  >
                    <Icon />
                    {link.label}
                  </Link>
          ...
          <button
            ...
            className="flex items-center gap-3.5 px-6 py-4 text-sm font-medium text-body duration-300 ease-in-out hover:text-primary dark:text-bodydark lg:text-base"
          >
            <svg
              className="fill-current"
              width="22"
