...
/** Player dashboard sidebar (TailAdmin dark shell + declarative menu). */
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <Link href="/dashboard" className="flex items-center gap-2.5">
          ...
          />
          <span className="text-lg font-bold" style={{ color: 'var(--page-text)' }}>MLBB Togo</span>
        </Link>
